...
const double kMaxCameraDistance = 90.0;
...
class Camera {
 ...
 public:
  ...
  /** Set camera distance */
  void SetDistance(double modifier);
  ...
  /**
   * @brief Move Moves the camera around the X,Y axis.
   * @param modifierX Sign of the X direction.
   * @param modifierY Sign of the Y direction.
   */
  void Move(double modifierX, double modifierY) ;

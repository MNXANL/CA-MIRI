...
/*
    ...
    std::vector< std::vector<float> > Grid( NUM_PARTICLES*NUM_PARTICLES*NUM_PARTICLES );
    ...
    // For each level of detail 2 to NUM_PARTICLES+1 ...
    for (int LOD = 2; LOD <= NUM_PARTICLES; ++LOD ){
